...
|[leaflet-languageselector](https://github.com/KristjanESPERANTO/leaflet-languageselector) |CC0 [*](https://github.com/KristjanESPERANTO/leaflet-languageselector/blob/master/LICENSE) | 1.1.0 | A control to switch between languages. |
