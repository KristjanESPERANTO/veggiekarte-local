...
! function(e, r) {
    ...
    e.FeatureGroup.SubGroup = e.FeatureGroup.extend({
        ...
        _addLayerToGroup: function(e) {
            ...
            return this._layers[r] = e, this._map && this._parentGroup.addLayer(e), this.fire("layeradd", {
                layer: e
            })
        },
        _removeLayerFromGroup: function(e) {
            ...
            return e = this._layers[r], e.removeEventParent(this), this._map && e && this._parentGroup.removeLayer(e), delete this._layers[r], this.fire("layerremove", {
                layer: e
            })
        },
